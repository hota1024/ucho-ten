...
export const viewProfilePage = tv({
    slots: {
        ...
        ProfileCopyButton: 'h-[32px] w-[32px] ml-[10px] mr-[10px] border-[2px] border-[#929292] rounded-full flex justify-center items-center',
        ProfileActionButton: 'h-[32px] w-[32px] ml-[10px] mr-[10px] border-[2px] border-[#929292] rounded-full flex justify-center items-center',
